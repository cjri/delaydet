...
int main(int argc, char *argv[]){
    ...
    for (double sigma=0.01;sigma<=1.91;sigma=sigma+0.05) {
        ...
        for (int i=0;i<1000;i++) {
            ...
            DoPropagationStoch(0,N_s,N,mu,dt,max,sigma,lL,initial_freqs,muts,fact_store,data,haps,rgen);
            lL_tot=lL_tot+lL;
        }
        lL_tot=lL_tot/1000.0;
        cout << "Likelihood " << sigma << " " << beta_best << " " << lL_tot << "\n";
        if (lL_tot>lL_top) {
            lL_top=lL_tot;
            sigma_top=sigma;
            reject=0;
        ...
        if (first1==0) {
            if (lL_tot>lL_opt_best) {
                ...
                for (int i=0;i<1000;i++) {
                    ...
                    DoPropagationStoch(1,N_s,N,mu,dt,max,sigma,lL,initial_freqs,muts,fact_store,data,haps,rgen);
                    lL_tot=lL_tot+lL;
                }
                lL_tot=lL_tot/1000;
